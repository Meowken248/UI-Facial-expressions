...
export interface BrowConfig { rotation?: number; translateX?: number; translateY?: number; curve?: 'soft' | 'raised' | 'sad' | 'angry' | 'thinking'; color?: string }
export interface MouthConfig { shape: 'smile' | 'angry' | 'small-smile' | 'wide-smile' | 'laugh' | 'open' | 'o' | 'sad' | 'frown' | 'tongue' | 'wave' | 'sleep' | 'squiggly' | 'worried-open'; translateY?: number; scaleX?: number }
