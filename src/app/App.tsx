...
export default function App() {
  ...
  return (
    <main>
      ...
      {/* ── Emotion controls (only in emotion mode) ── */}
      {!assistantMode && (
        <EmotionControls
