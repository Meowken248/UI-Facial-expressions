...
interface VehicleErrorCardProps {
  onCallRescue?: () => void;
  onCheckError?: () => void;
}

export function VehicleErrorCard({ onCallRescue, onCheckError }: VehicleErrorCardProps) {
  return (
    <AlertCard
      variant="warning"
      icon={
      ...
      title="Xe đang gặp sự cố"
      description="Không khuyến nghị tiếp tục di chuyển."
      actions={[
        {
          label: 'Gọi cứu hộ',
          variant: 'outline',
